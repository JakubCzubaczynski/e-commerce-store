...
const search = (categoryContent) => {
    ...
    rangeInput.addEventListener('input', () => {
        ...
        document.querySelector('.range-value').innerHTML = `Value: $${rangeInput.value}`;
        ...
        if (filtered.length > 0) {
            ...
            document.querySelector('.products-wrapper').innerHTML = "<h3>Sorry, No Products Matched Your Search</h3>"
